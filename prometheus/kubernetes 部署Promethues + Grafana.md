# kubernetes 部署Promethues Grafana
...
knode01   NotReady   <none>                 21d   v1.21.0   192.168.31.11   <none>        Rocky Linux 8   4.18.0-240.22.1.el8.x86_64   docker://20.10.6
knode02   NotReady   <none>                 21d   v1.21.0   192.168.31.12   <none>        Rocky Linux 8   4.18.0-240.22.1.el8.x86_64   docker://20.10.6
...
![](C:\Kubernetes\NFS\K8S工作节点监控效果图.png)

![](C:\Kubernetes\NFS\K8S资源对象状态监控效果图.png)

![](C:\Kubernetes\NFS\K8S集群资源监控效果图.png)